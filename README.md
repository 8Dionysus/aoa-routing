...
- post-W10 live-session reentry review contract: [docs/LIVE_SESSION_REENTRY_ROUTE_REVIEW.md](docs/LIVE_SESSION_REENTRY_ROUTE_REVIEW.md), `schemas/live-session-reentry-route-review.schema.json`, and `examples/live_session_reentry_route_review.example.json`
- Wave 1 owner route signal / route decision / owner dispatch seam: [docs/AGON_GATE_DECISION_BOUNDARY.md](docs/AGON_GATE_DECISION_BOUNDARY.md), `schemas/owner-dispatch-seam.schema.json`, and `examples/owner_dispatch_seam.example.json`
...
- live-session reentry review contract: [docs/LIVE_SESSION_REENTRY_ROUTE_REVIEW](docs/LIVE_SESSION_REENTRY_ROUTE_REVIEW.md), `schemas/live-session-reentry-route-review.schema.json`, and `examples/live_session_reentry_route_review.example.json`
