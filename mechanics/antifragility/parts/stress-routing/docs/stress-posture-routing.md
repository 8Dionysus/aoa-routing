...
The current stress-posture landing stays contract-only: doctrine, one schema, and one example without changing generated router outputs yet.

## Preferred route postures

This contour uses a small posture vocabulary:
...
A healthy stress-posture contract landing makes it possible to point to:
