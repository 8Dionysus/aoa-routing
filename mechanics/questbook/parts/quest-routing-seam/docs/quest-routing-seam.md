...
In this contour, routing may ingest only:

- `generated/quest_catalog.min.json`
- `generated/quest_dispatch.min.json`

Production routing does not read `.example.json` quest fixtures.
The adjunct `mechanics/questbook/parts/quest-board-seam/generated/quest_board.min.example.json` surface is example-only and does not feed the live router in this contour.
...
Tiny-model-safe entry remains deferred in this contour.
