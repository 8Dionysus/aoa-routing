...
- `mechanics/recurrence/parts/return-navigation/docs/recurrence-navigation-boundary.md` remains the governing routing
  doctrine for return posture.
- `mechanics/experience/parts/adoption-routing/docs/adoption-reentry-routing.md` remains the adoption-specific reentry
  doctrine.
