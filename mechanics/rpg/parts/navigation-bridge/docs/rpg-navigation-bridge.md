...
This note defines the bridge-contour RPG navigation seam for `aoa-routing`.
...
A bridge-contour RPG navigation card may:
...
This bridge-contour seam should consume only derived owner surfaces.
...
In this example pack the bundle remains example-only.
...
The bridge-contour card may later help tiny local wrappers, but it should stay source-first and narrow.
