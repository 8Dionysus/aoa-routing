# TOS DOSSIER ROUTING BOUNDARY

## Purpose

Allows ToS dossier preparation but blocks direct writes.
...
- aoa-routing v0.6 surface
- explicit inputs and outputs
- advisory route artifacts and gate destinations
...
- harvest approval, adoption approval, KAG promotion, or ToS intake decisions
- meaning of routed dossiers, summaries, or candidate records
...
- route signals pointing at reviewable candidate records
- owner-local landing hints
- gate decision route signals, never decisions themselves
- links to derived summaries, never certification or meaning
- dossier route pointers where permitted

## Gates This Route Must Point To

Routing records only point at these gates; they do not satisfy or approve them.
