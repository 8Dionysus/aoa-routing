# Charter Change Routing

Status: candidate v0.8.0
Repo landing: `aoa-routing`  
Layer: Experience Polis Governance

## Purpose

Routing charter amendment proposals to owner surfaces.

v0.8 adds a polis-governance contour around the experience mechanic. Earlier contours forged capture, distillation, certification, deployment, federation and adoption. This contour asks a harder question: **who may decide when those paths conflict?**
...
- aoa-routing receives only bounded governance surfaces.
