...
ESCAPE_VALUE = "__office_service_not_allowed__"

OFFICE_SERVICE_CONTRACTS = (
    ('first_office_route_gate_v1', 'first_office_route_gate_v1.json'),
    ('installation_route_plan_v1', 'installation_route_plan_v1.json'),
    ('office_handoff_packet_v1', 'office_handoff_packet_v1.json'),
    ('office_route_gate_v1', 'office_route_gate_v1.json'),
    ('rollback_route_signal_v1', 'rollback_route_signal_v1.json'),
    ('service_escalation_signal_v1', 'service_escalation_signal_v1.json'),
    ('service_handoff_graph_v1', 'service_handoff_graph_v1.json'),
    ('service_to_agon_boundary_signal_v1', 'service_to_agon_boundary_signal_v1.json'),
    ('tos_boundary_route_guard_v1', 'tos_boundary_route_guard_v1.json'),
)

CONTRACT_PATH_OVERRIDES = {
    "first_office_route_gate_v1": (
        "mechanics/experience/parts/office-route-gate/schemas/first_office_route_gate_v1.json",
        "mechanics/experience/parts/office-route-gate/examples/first_office_route_gate_v1.example.json",
    ),
    "installation_route_plan_v1": (
        "mechanics/release-support/parts/installation-routing/schemas/installation_route_plan_v1.json",
        "mechanics/release-support/parts/installation-routing/examples/installation_route_plan_v1.example.json",
    ),
    "office_handoff_packet_v1": (
        "mechanics/experience/parts/office-route-gate/schemas/office_handoff_packet_v1.json",
        "mechanics/experience/parts/office-route-gate/examples/office_handoff_packet_v1.example.json",
    ),
    "office_route_gate_v1": (
        "mechanics/experience/parts/office-route-gate/schemas/office_route_gate_v1.json",
        "mechanics/experience/parts/office-route-gate/examples/office_route_gate_v1.example.json",
    ),
    "rollback_route_signal_v1": (
        "mechanics/antifragility/parts/rollback-routing/schemas/rollback_route_signal_v1.json",
        "mechanics/antifragility/parts/rollback-routing/examples/rollback_route_signal_v1.example.json",
    ),
    "service_escalation_signal_v1": (
        "mechanics/experience/parts/service-handoff/schemas/service_escalation_signal_v1.json",
        "mechanics/experience/parts/service-handoff/examples/service_escalation_signal_v1.example.json",
    ),
    "service_handoff_graph_v1": (
        "mechanics/experience/parts/service-handoff/schemas/service_handoff_graph_v1.json",
        "mechanics/experience/parts/service-handoff/examples/service_handoff_graph_v1.example.json",
    ),
    "service_to_agon_boundary_signal_v1": (
        "mechanics/experience/parts/service-handoff/schemas/service_to_agon_boundary_signal_v1.json",
        "mechanics/experience/parts/service-handoff/examples/service_to_agon_boundary_signal_v1.example.json",
    ),
    "tos_boundary_route_guard_v1": (
        "mechanics/boundary-bridge/parts/tos-kag-boundary/schemas/tos_boundary_route_guard_v1.json",
        "mechanics/boundary-bridge/parts/tos-kag-boundary/examples/tos_boundary_route_guard_v1.example.json",
    ),
}
...
class OfficeServiceContractTests(unittest.TestCase):
    ...
    def test_office_service_examples_match_schemas(self) -> None:
        self.assertTrue(OFFICE_SERVICE_CONTRACTS)
        missing_pairs: list[str] = []
        for stem, schema_file in OFFICE_SERVICE_CONTRACTS:
            override = CONTRACT_PATH_OVERRIDES.get(stem)
            if override is None:
                schema_path = ROOT / "schemas" / schema_file
                example_path = ROOT / "examples" / f"{stem}.example.json"
        ...
        self.assertFalse(missing_pairs, "missing office/service contract pair(s): " + ", ".join(missing_pairs))
    ...
    def test_office_service_schemas_reject_unknown_fields(self) -> None:
        exercised = 0
        for stem, schema_file in OFFICE_SERVICE_CONTRACTS:
            schema, example = load_contract(stem, schema_file)
    ...
    def test_office_service_schemas_reject_wrong_types_for_every_field(self) -> None:
        exercised = 0
        for stem, schema_file in OFFICE_SERVICE_CONTRACTS:
            schema, example = load_contract(stem, schema_file)
    ...
    def test_office_service_schemas_reject_missing_required_fields(self) -> None:
        exercised = 0
        for stem, schema_file in OFFICE_SERVICE_CONTRACTS:
            schema, example = load_contract(stem, schema_file)
    ...
    def test_office_service_schemas_reject_bad_array_items(self) -> None:
        exercised = 0
        for stem, schema_file in OFFICE_SERVICE_CONTRACTS:
            schema, example = load_contract(stem, schema_file)
    ...
    def test_office_service_schemas_reject_empty_strings(self) -> None:
        exercised = 0
        for stem, schema_file in OFFICE_SERVICE_CONTRACTS:
            schema, example = load_contract(stem, schema_file)
    ...
    def test_office_service_schemas_reject_const_escapes(self) -> None:
        exercised = 0
        for stem, schema_file in OFFICE_SERVICE_CONTRACTS:
            schema, example = load_contract(stem, schema_file)
    ...
    def test_office_service_schemas_reject_enum_escapes(self) -> None:
        exercised = 0
        for stem, schema_file in OFFICE_SERVICE_CONTRACTS:
            schema, example = load_contract(stem, schema_file)
    ...
    def test_office_service_schemas_reject_numeric_bound_escapes(self) -> None:
        for stem, schema_file in OFFICE_SERVICE_CONTRACTS:
            schema, example = load_contract(stem, schema_file)
            for path, value in walk_values(example):
